const MainContent = () => {
  return (
    <main className="flex flex-col-reverse md:flex-row gap-12 w-full items-center justify-center mt-4 md:mt-32 p-6">
      <div className="w-80 h-80 sm:w-[26rem] sm:h-[26rem] rounded-full">
        <img
          src="/me.jpg"
          alt="profile foto"
      ...
      <div className="flex flex-col gap-2">
        ...
        <div>
          <ul className="text-black font-bold text-lg md:text-xl flex justify-center items-center gap-4 mt-4">
